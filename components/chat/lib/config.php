...
// Database name:
$config['dbConnection']['name'] = 'realmd';
// Database type:
...
// Available languages:
$config['langAvailable'] = array('fr');
// Default language:
$config['langDefault'] = 'fr';
// Language names:
$config['langNames'] = array('fr'=>'Français');

// Available styles:
$config['styleAvailable'] = array('Radium');
// Default style:
$config['styleDefault'] = 'radium';
