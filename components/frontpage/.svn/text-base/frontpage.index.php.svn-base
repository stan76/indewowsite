...
foreach ($multirealms as $realmnow_arr){
    if((int)$MW->getConfig->components->right_section->server_information){
        ...
        if((int)$MW->getConfig->generic->use_archaeic_dbinfo_format){
            ...
            $mangosALL = array(
                'db_type' => 'mysql',
                'db_host' => $realm_data_explode['0'],
                'db_port' => $realm_data_explode['1'],
                'db_username' => $realm_data_explode['2'],
                'db_password' => $realm_data_explode['3'],
                'db_name' => $realm_data_explode['4'],
                'db_char' => $realm_data_explode['5'],
                'db_encoding' => 'utf8'
            );
        }else{
            ...
            $mangosALL = array(
                'db_type' => 'mysql',
                'db_host' => $realm_data_explode['3'],
                'db_port' => $realm_data_explode['2'],
                'db_username' => $realm_data_explode['0'],
                'db_password' => $realm_data_explode['1'],
                'db_name' => $realm_data_explode['4'],
                'db_char' => $realm_data_explode['5'],
                'db_encoding' => 'utf8'
            );
