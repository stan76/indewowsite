...
function zerohonorfilter($var){
    ...
    foreach($charinfo_arr as $charinfo_item){
        ...
        $character = array(
            ...
            'race_icon'   => $offtmp .'/images/icon/race/'.$charinfo_item['race'].'-'.$charinfo_item['gender'].'.gif',
            'class_icon'   => $offtmp .'/images/icon/class/'.$charinfo_item['class'].'.gif',
            'rank_icon'   => $offtmp .'/images/icon/pvpranks/rank'.$char_rank_id.'.gif',
        );
