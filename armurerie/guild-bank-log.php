...
if(!isset($_SESSION['accountId'])) {
    header('Location: login.php?ref=' . urlencode(sprintf('guild-bank-log.php?r=%s&gn=%s', $armory->currentRealmInfo['name'], $guilds->guildName)));
}
...
$xml->XMLWriter()->writeAttribute('globalSearch', 1);
$xml->XMLWriter()->writeAttribute('lang', $armory->_locale);
$xml->XMLWriter()->writeAttribute('requestUrl', 'guild-bank-log.php');
