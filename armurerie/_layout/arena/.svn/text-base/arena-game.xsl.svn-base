...
<xsl:variable name="urlTeamSelected" select="concat('../../arena-team-game-chart.php?r=', 
												document('../../team-info-last.php')/page/arenaTeamCommand/@realm, 
                                                '&amp;t=', 
                                                document('../../team-info-last.php')/page/arenaTeamCommand/@teamName, 
                                                '&amp;ts=', document('../../team-info-last.php')/page/arenaTeamCommand/@teamSize)" />
<xsl:variable name="isTeamSelected" select="document('../../team-info-last.php')/page/arenaTeam/@teamSize" />
            ...
            <tbody>
                <xsl:for-each select="/page/game/team">                	
                	...
                	<xsl:for-each select="current()/member">                    
                        ...
                        <tr>
                            <td><a href="character-sheet.php?{@url}"><xsl:value-of select="@characterName"/></a></td>
                            <td style="overflow:hidden;">
								<xsl:choose>
									...
									<xsl:otherwise>
										<a href="arena-team-game-chart.php?{$teamUrl}" class="graphLink staticTip" 
										...
										<a class="truncateMe graphTxt staticTip" onmouseover="setTipText('{$loc/strs/arenaReport/str[@id='viewTeamProfile']}');" 
											href="team-info.php?{$teamUrl}"><xsl:value-of select="$teamName"/></a>									
									</xsl:otherwise>								
								</xsl:choose>
							</td>
                            <td class="centNum">
