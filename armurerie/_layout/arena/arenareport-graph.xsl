...
<xsl:variable name="docHeader" select="document(concat('../../team-info.php?', /page/gameListingChart/arenaTeam/@teamUrl))/page/teamInfo/arenaTeam" />
					...
					<tr>
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									...
									<a class="graphTxt staticTip" onmouseover="setTipText('{$loc/strs/arenaReport/str[@id='viewTeamProfile']}');" 
										href="team-info.php?{@teamUrl}"><xsl:value-of select="@ot" /></a>
								</xsl:otherwise>
							</xsl:choose>
						</td>                    
						...
						<td style="font-weight: normal;">
							...
							<a class="staticTip goToMatchReport" onmouseover="setTipText('{$loc/strs/arena/str[@id='goToMatchReport']}')" 
								href="arena-game.php?gid={@id}&amp;r={/page/gameListingChart/arenaTeam/@realmName}"> </a>
