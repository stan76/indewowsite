                ...
                <div class="list">
					...
					<div class="full-list">
						<div class="info-pane">
							 <blockquote>							 												
							 	<b class="iarenateams">
									<h4 style="width: 300px;"><a href="battlegroups.php"><xsl:value-of select="$loc/strs/arena/str[@id='arena-ladders']"/></a></h4>
				...
				<tbody>
					<xsl:for-each select="arenaTeams/arenaTeam">
						...
						<tr onmouseover="popIconLarge('teamIconBoxFlash','iconObject{position()}')" onmouseout="popIconSmall('teamIconBoxFlash','iconObject{position()}')">
							...
							<td style="padding-left: 40px;"><a href="team-info.php?{@realmUrl}"><xsl:value-of select="@name" /></a></td>
