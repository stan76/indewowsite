			...
			<script type="text/javascript" src="http://static.wowhead.com/widgets/power.js"></script>
				<xsl:for-each select="guildBank/banklogs/banklog">
					<xsl:if test="not(@unknown = 1)">
						...
						<tr>
							<td><a href="character-sheet.php?n={@player}&amp;r={/page/guildInfo/guildHeader/@realm}"><xsl:value-of select="@player" /></a></td>
							...
							<td>
								...
								<xsl:if test="not(@otab = '')">
									<span class="staticTip" onmouseover="setTipText('{/page/guildInfo/guildBank/bags/bag[@id=current()/@otab]/@name}')" 
										style="background: url('http://eu.wowarmory.com/wow-icons/_images/21x21/{/page/guildInfo/guildBank/bags/bag[@id=current()/@otab]/@icon}.png') no-repeat; 
							...
							<td>
								...
								<xsl:if test="not(@dtab = '')">
									<span class="staticTip" onmouseover="setTipText('{/page/guildInfo/guildBank/bags/bag[@id=current()/@dtab]/@name}')" 
										style="background: url('http://eu.wowarmory.com/wow-icons/_images/21x21/{/page/guildInfo/guildBank/bags/bag[@id=current()/@dtab]/@icon}.png') no-repeat; 
										display: block; width: 21px; height: 21px;" />
								</xsl:if>
							</td>
							<td>								
								<xsl:choose>
									<xsl:when test="$subInfo">
										...
										<a href="http://fr.wowhead.com/item={@id}" class="rarity{$subInfo/@qi}" id="i={$subInfo/@id}" 
											style="background: url('http://eu.wowarmory.com/wow-icons/_images/21x21/{$subInfo/@icon}.png') no-repeat; padding: 2px 0 5px 25px;">
