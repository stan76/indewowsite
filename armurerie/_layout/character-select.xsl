    ...
    <xsl:if test="not(@selected)">
        <tr>
            <td style="text-align:left; padding-left: 3px;">
                ...
                <a href="character-sheet.php?{@url}"><xsl:value-of select="@name" /></a>
            </td>
            ...
            <td>
                <a href="guild-info.php?n={@guild}&amp;r={@realm}"><xsl:value-of select="@guild" /></a>
            </td>
            <td style="text-align:left; padding-left:3px;">
    	...
    	<div class="select-charwrap">
			<div class="select-char1">
				<div>
                    ...
                    <h6><a id="{$primChar/@url}" class="selChar selPrimaryChar" href="character-sheet.php?{$primChar/@url}"><xsl:value-of select="$primChar/@name"/></a></h6>
                    <span>
    ...
    <xsl:if test="count(/page/characters/character/@selected) &gt; 1"> 
        <xsl:for-each select="/page/characters/character[@selected = '2']">
            <div class="select-char2">
                ...
                <h6><a href="character-sheet.php?{@url}"><xsl:value-of select="@name" /></a></h6>&#160;(<xsl:value-of select="@level" />) - 
