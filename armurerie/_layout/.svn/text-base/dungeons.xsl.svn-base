								...
								<xsl:for-each select="$locDungeons/page/dungeons/dungeon[@release=$releaseId]">
									...
									<tr id="toggleExpand{$dungeonKey}" class="expand-list">
										...
										<td width="250" valign="top" class="{$altId}">
											<a href="http://fr.wowhead.com/zone={$dungeonId}#drops">
											...
											<div class="d-bosses" id="showHideBosses{$dungeonKey}" style="display:none;">
												<xsl:for-each select="$locDungeons/page/dungeons/dungeon[@key=$dungeonKey]/boss">
													<em></em><a href = "http://fr.wowhead.com/zone={$dungeonId}#npcs"><xsl:value-of select = "@name" /></a>
												</xsl:for-each>
											</div>
										</td>
								...
								<xsl:when test="$releaseId = 1">
									<div class="table-footnote">
										<span style="padding-left: 30px;">		  
											<xsl:value-of select="$loc/strs/unsorted/str[@id='armory.dungeons.seealsocolon']"/>&#160;<a href="search.php?source=dungeon&amp;dungeon=badgeofjustice&amp;boss=all&amp;difficulty=all&amp;searchType=items"><img src="/wow-icons/_images/21x21/spell_holy_championsbond.png" class="boj" /><xsl:value-of select="$loc/strs/itemsOptions/str[@id='armory.item-search.select.bojr']"/></a>
										</span><br /><br />
									</div>
								</xsl:when>
								<xsl:when test="$releaseId = 2">
									<div class="table-footnote">
										<span style="padding-left: 30px;">		  
											...
											<a href="search.php?source=dungeon&amp;dungeon=emblemofheroism&amp;boss=all&amp;difficulty=all&amp;searchType=items"><img src="http://eu.wowarmory.com/wow-icons/_images/21x21/spell_holy_proclaimchampion.png" class="boj" /><xsl:value-of select="$loc/strs/itemsOptions/str[@id='armory.item-search.select.eohr']"/></a></span>&#160;&#160;
										<span><a href = "search.php?source=dungeon&amp;dungeon=emblemofvalor&amp;boss=all&amp;difficulty=all&amp;searchType=items"><img src="http://eu.wowarmory.com/wow-icons/_images/21x21/spell_holy_proclaimchampion_02.png" class="boj" /><xsl:value-of select="$loc/strs/itemsOptions/str[@id='armory.item-search.select.eovr']"/></a></span>&#160;&#160;
										<span><a href = "search.php?source=dungeon&amp;dungeon=emblemofconquest&amp;boss=all&amp;difficulty=all&amp;searchType=items"><img src="http://eu.wowarmory.com/wow-icons/_images/21x21/spell_holy_championsgrace.png" class="boj" /><xsl:value-of select="$loc/strs/itemsOptions/str[@id='armory.item-search.select.eocr']"/></a></span>&#160;&#160;
										<span><a href = "search.php?source=dungeon&amp;dungeon=emblemoftriumph&amp;boss=all&amp;difficulty=all&amp;searchType=items"><img src="http://eu.wowarmory.com/wow-icons/_images/21x21/spell_holy_summonchampion.png" class="boj" /><xsl:value-of select="$loc/strs/itemsOptions/str[@id='armory.item-search.select.eotr']"/></a></span>&#160;&#160;
										<span><a href = "search.php?source=dungeon&amp;dungeon=emblemoffrost&amp;boss=all&amp;difficulty=all&amp;searchType=items"><img src="http://eu.wowarmory.com/wow-icons/_images/21x21/inv_misc_frostemblem_01.png" class="boj" /><xsl:value-of select="$loc/strs/itemsOptions/str[@id='armory.item-search.select.eofr']"/></a></span>&#160;&#160;
										<br/><br/>
									</div>
								</xsl:when>
							</xsl:choose>
