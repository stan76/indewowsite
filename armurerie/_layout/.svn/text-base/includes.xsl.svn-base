...
<!-- battlegroups list -->
<xsl:variable name="bgXML" select="document('../battlegroups.php')/page/battlegroups" />
...
<head>
	...
	<script type="text/javascript">
		...
		var isLoggedIn = ("<xsl:value-of select="document('../login-status.php')/page/loginStatus/@username"/>" != '');
	  ...
	  <div class="inner-container">
		<xsl:choose>
			...
			<xsl:otherwise><!-- *INTERIOR PAGES TEMPLATE -->
				<div class="int-top">
					<div class="logo">
						<a href="index.php"><span><xsl:value-of select="$loc/strs/common/str[@id='the-wow-armory']"/></span></a>
					</div>
					</div>
                    <div class="int">
...
<xsl:template name="searchInput">
	<div class="search-module">
		...
		<form name="formSearch" action="search.php" method="get" onSubmit="return menuCheckLength(document.formSearch);">
...
<xsl:template name="errorSection">
	<div class="profile-wrapper">
		...
		<blockquote><b class="iguilds"><h4><a href="index.php"><xsl:value-of select="$loc/strs/unsorted/str[@id='armory.labels.armory']"/></a></h4><h3>
		<xsl:choose>
...
<xsl:choose>
    ...
    <xsl:when test="/page/customrss or /page/@requestUrl = 'character-feed.php'">
		<xsl:call-template name="related-info">
