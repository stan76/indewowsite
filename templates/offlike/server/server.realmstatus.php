<img src="<?php echo $currtmp; ?>/images/realmstatus_background.jpg" border="0" width="100%" height="135" />
<br />
...
<?php
$up = '<img src="'.$currtmp.'/images/_right/_status/on.png" style="vertical-align: bottom;" />';
$down = '<img src="'.$currtmp.'/images/_right/_status/off.png" style="vertical-align: bottom;" />';
