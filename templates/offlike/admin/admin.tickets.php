<br>
<?php builddiv_start(1, "Gestion des tickets") ?>
<?php $MANG = new Mangos; ?>
...
<?php write_metalborder_header(); ?>
    ...
    <tbody>
       <tr> 
       <td class="rankingHeader" align='left' colspan='5'><center>Liste des tickets actuellement ouvert</center></td>
       </tr>
       <tr> 
    ...
    <tr>
      ...
      <td class="rankingHeader" align="center" nowrap="nowrap">Nom</td>
      <td class="rankingHeader" align="center" nowrap="nowrap">Message</td>
	  <td class="rankingHeader" align="center" nowrap="nowrap">Commentaire MJ</td>
    </tr>
