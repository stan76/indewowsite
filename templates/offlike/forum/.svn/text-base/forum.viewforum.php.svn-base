...
<table id="iconLegend" cellpadding="0" cellspacing="0" width="100%">
<tbody>
<tr>
<td>
...
<tr>
<td>
<small><div align="left">L&eacute;gende:</div></small>
</td>
</tr>
</tbody>
</table>
...
<br />
  ...
  <table class="tb2" border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>	<tr>
    <td><img src="<?php echo $currtmp; ?>/images/square-new.gif" style="margin: 0pt 3px 0pt 2px;" alt="New Post" border="0"><font color=red>&nbsp;<?php echo $lang['newsubject'] ?>&nbsp;</font></td>
    <td><img src="<?php echo $currtmp; ?>/images/square.gif" style="margin: 0pt 3px 0pt 2px;" alt="Unviewed Post" border="0"><font color=blue>&nbsp;<?php echo $lang['readsubject'] ?>&nbsp;</font></td>
    <td><img src="<?php echo $currtmp; ?>/images/square-grey.gif" alt="Viewed Post" border="0"><font color=grey>&nbsp;<?php echo $lang['notreadsubject'] ?>&nbsp;</font></td>
      </tr>
  </tbody></table>
