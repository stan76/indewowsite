                                    ...
                                    <tr>
                                        ...
                                        <div>
											...
											<div class="shell">
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td style="background: url('<?php echo $currtmp."/images/armory/chars/".$post['avatar']; ?>'); width: 64px; height: 64px;">
															</td>
                                                        </tr>
                                                    </table>
                                                    <div class="frame">
                                        ...
                                        <!-- //Begin Character Control Panel// -->
											...
											<div id="default-icon-panel">
												...
												<table cellspacing="0" cellpadding="0" border="0">
                                                        <tr>
                                                            <td style="background: url('<?php echo $currtmp."/images/icon/race/".$post['mini_race']; ?>'); width: 18px; height: 18px;">
															</td>
                                                        </tr>
                                                    </table>
											    </div>
...
<?php endif; ?>
                                                            <li class="icon-realm"><small>Nb. de poste: <?php echo $posts; ?></small></li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div id="postid<?php echo $post['bg']; ?>1">
                                            <ul>
                                                <li style="display:table-cell;"><span class="white"><b>Poste #<?php echo $post['pos_num']; ?></b>&nbsp; | &nbsp;<small><?php echo $post['posted']; ?></small></span></li>
                                            </ul>
                                        </div>
