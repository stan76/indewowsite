...
<table>
  <tr>
  <td>
  <img align="left" src="<?php echo $currtmp; ?>/images/letters/t.gif"><?php echo $lang['copy_page_desc'];?><br />
	<?php echo $lang['copy_instructions'];?><br /><br />
	<center>Pour copier un personnage, il vous faut <font color="blue"><?php echo $char_points; ?></font> points de vote.<font color="blue"><u>
...
<?php
    ...
    $MANG = new Mangos;
		...
		if($char_points > $available_points){
			$disabled = disabled;
			echo "<font color=\"red\"><b><center>Vous n'avez pas assez de points pour copier un personnage !</b></center></font>";
		}else{
			$disabled = enabled;
