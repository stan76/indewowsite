...
<!--Shadow Top-->
  ...
  <tr>
    ...
    <p>
      ...
      <tr><td>
        <form action="index.php?n=account&sub=restore" method="post">
        <table width = "520" style = "border-width: 0px; border-style: dotted; border-color: #928058;"><tr><td>
        ...
        <tr>
          <td align = "center">
           ...
           <div style="border: 0px dotted #1E4378;background:none;margin:4px;padding:6px 9px 6px 9px;text-align:center;width:70%;">
            ...
            <br /><br />
            <?php echo $lang['secretq'];?>:<br />
            <select name="secretq1" style="width:120px;">
              <option <?php if(isset($profile['secretq2']) && $profile['secretq2'] == 0)echo "selected"; ?> value="0">Aucune</option>
              <?php
