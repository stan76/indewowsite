									...
									<div class="insert">
										<blockquote>
											<div class="post-top">
												...
												<div style="width:auto; padding:0 10px 10px 10px;">
		...
		<tbody>
			<tr>
				<td>
					...
					<a href="#">AHREF ahref AHREF ahref</a>
				</td>
			</tr>
			<tr class="r0">
				<td>
					<span>SPAN span SPAN span</span><br />
					<a href="#">AHREF ahref AHREF ahref</a><br />
					<a href="#"><span>SPAN span</span> AHREF ahref</a>
				</td>
			</tr>
			<tr class="r1">
				<td>
					<span>SPAN span SPAN span</span><br />
					<a href="#">AHREF ahref AHREF ahref</a><br />
					<a href="#" class="link"><span>SPAN span</span> AHREF ahref</a>
				</td>
			</tr>
			<tr class="r0">
				<td>
					<form>
						<input type="button" class="blueButton" value="Blizzard" />
					</form>
				</td>
			</tr>
			<tr class="r1">
